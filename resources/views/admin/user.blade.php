...
<div class="card-header py-3" align="right">
    <button class="btn btn-primary btn-sm btn-flat" data-toggle="modal" datatarget="#modal-add"><i class="fa fa-plus"></i>Tambah</button>
</div>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="card-body">
                ...
                <div class="modal-body">
                    <div class="form-group"><label class="col-lg-20 controllabel">Nama User</label>
                        ...
                        <div class="form-group"><label class="col-lg-20 controllabel">Email User</label>
                            <div class="col-lg10"><input type="email" name="email" required class="form-control"></div>
